...
The ideal research design would be a pure experiment with random assignment. However, because the resident research project does not randomly assign patients to conditions going forward, it therefore falls under the category of _**quasi-experiment**_ which means it is more vulnerable to threats to validity.
